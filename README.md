...
## 最近更新
1. 我们添加了日志功能，可以把每次提交成功或者失败编译的日志自动提交到仓库以便更改代码bug并进行审查
2. 更改了新功能提交的模板，可以更加快捷提交新功能
3. 改名字了所以更改了LICENSE

## 新功能/新版本提要
* 我们决定在下一次0.9.1更新的时候主要更新[`wapi.hpp`](wapi.hpp)的功能，并且更新控制台功能。
* 我们决定在0.9.2或者0.9.2的预览版(也有可能是0.9.1的后续更新)中添加部分对虚拟终端的支持。
* 我们决定在0.9.3更新对Linux控制台的部分内容，届时项目可能重构。
